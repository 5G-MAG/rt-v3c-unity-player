...
[CreateAssetMenu(fileName = "VPCCMouseCamController", menuName = "Scriptable/CamControllers/VPCC/Mouse")]
public class VPCCMouseCamController : CameraControllerVPCC
{
    ...
    void UpdateMoveAround()
    {
        if (enable)
        {
            ...
            {
                mem_pos = Input.mousePosition;
            }
            if (Input.GetMouseButton(0))
            {
                Vector2 pos = Input.mousePosition;
                Vector2 delta_pos = pos - mem_pos;
